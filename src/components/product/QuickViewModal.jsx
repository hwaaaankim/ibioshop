...
function QuickView() {
  ...
  return (
    <div className='h-[535px] w-[1000px] m-auto p-5'>
        ...
        <div className='w-full flex flex-col'>
          <div className='w-full'>
            ...
            <div className="flex flex-col my-5">
              ...
              <div className="text-xs flex items-center mt-3"><span className='mr-2'>Availability:</span>
            ...
            <div className="mt-10">
              ...
              <div class="text-[12px]">
                <span className='flex items-center'>
                  ...
                  <label className="text-[#666] mt-1 mr-2.5 font-normal">Checkbox</label>
                </span>
                <div className="mb-5">
                  <div class="relative my-2.5">
                    <label for="checkbox_1" className='min-h-[20px] pl-5 font-normal cursor-pointer text-[12px]'>
                      <input
                        type="checkbox"
                        name="option[232][]"
                        value="36"
