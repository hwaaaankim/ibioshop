        ...
        <table className="mb-3 w-full max-w-full text-neutral-600 bg-transparent border border-solid border-collapse border-spacing-0 box-border ">
          ...
          {whishs.map((wish)=> (
            <tr key={wish.id} className='hover:bg-gray-100 align-top'>
              ...
              <td className="text-right border border-solid p-2">
                <div className="price">
                  <span className="font-semibold text-lg" style={{color:'#094bad'}}>{wish.unitPrice.priceNew}</span>
                  {wish.unitPrice?.priceOld && <span className="font-medium text-sm line-through inline-block px-2 leading-5" 
                  style={{color: '#aaa'}}>{wish.unitPrice?.priceOld}</span>}
                </div>
              </td>
              <td className="text-right border border-solid p-2">
